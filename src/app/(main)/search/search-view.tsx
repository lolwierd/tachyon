      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          ...
          <input
            ...
            className="w-full border-b border-border-subtle bg-transparent py-4 pl-8 pr-4 text-base text-text placeholder:text-text-faint transition-colors duration-150 focus:border-text-faint focus:outline-none"
          />
        </div>
