...
import { getChapterList, getChapterPages, getSeriesDetail, search } from "./theblank";

const fetchMock = vi.fn();

describe("theblank source adapter", () => {
  beforeEach(() => {
      ...
      new Response(
        `
          <div class="c-tabs-item__content">
            <a href="https://theblank.net/manga/test-manga/">
              <img data-src="https://cdn.example.com/cover.jpg" />
            </a>
            <div class="post-title"><a href="https://theblank.net/manga/test-manga/">Test Manga</a></div>
          ...
          <div class="c-tabs-item__content">
            ...
            <div class="post-title"><a href="https://theblank.net/manga/test-manga/">Duplicate</a></div>
          </div>
        `,
        { status: 200 },
      ),
  ...
  it("parses series detail page", async () => {
        ...
        `
          <html>
            ...
            <body>
              ...
              <div class="summary__content"><div class="manga-excerpt">A great manhwa about testing.</div></div>
    ...
    expect(fetchMock.mock.calls[0]?.[0]).toBe(
      "https://theblank.net/manga/test-manga/",
    );
    expect(detail).toEqual({
      ...
      slug: "test-manga",
      coverUrl: "https://cdn.example.com/cover.jpg",
      description: "A great manhwa about testing.",
      authors: ["Author A"],
      tags: ["Drama"],
      type: "Manhwa",
      status: "Ongoing",
  ...
  it("returns chapters in ascending order from AJAX response", async () => {
        ...
        `
          <ul class="main">
            <li class="wp-manga-chapter">
              <a href="https://theblank.net/manga/test-manga/chapter-10/">Chapter 10</a>
            </li>
            <li class="wp-manga-chapter">
              <a href="https://theblank.net/manga/test-manga/chapter-9/">Chapter 9</a>
            </li>
            <li class="wp-manga-chapter">
              <a href="https://theblank.net/manga/test-manga/chapter-8/">Chapter 8</a>
            </li>
          </ul>
        `,
        { status: 200 },
    ...
    expect(fetchMock).toHaveBeenCalledOnce();
    expect(fetchMock.mock.calls[0]?.[0]).toContain("/manga/test-manga/ajax/chapters/");
  ...
  it("extracts page images from reading content", async () => {
    ...
    expect(fetchMock.mock.calls[0]?.[0]).toBe(
      "https://theblank.net/manga/test-manga/chapter-1/",
    );
  ...
  it("surfaces upstream failures", async () => {
    ...
    await expect(search("broken-query-theblank")).rejects.toThrow(
      "TheBlank request failed: 503 Down",
    );
  });
  ...
  it("retries transient failures before succeeding", async () => {
    fetchMock
      ...
      .mockResolvedValueOnce(
        new Response(
          `
            <div class="c-tabs-item__content">
              <a href="https://theblank.net/manga/retry-manga/">
                <img src="https://cdn.example.com/cover.jpg" />
              </a>
              <div class="post-title"><a href="https://theblank.net/manga/retry-manga/">Retry Manga</a></div>
            </div>
          `,
          { status: 200 },
        ),
    ...
    const results = await search("retry-theblank");
